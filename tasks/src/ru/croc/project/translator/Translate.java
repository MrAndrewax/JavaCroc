package ru.croc.project.translator;
...
//Это код Жени. Я тупо скопипастил пока. Позже буду разбираться и переписывать под себя.
public class Translate {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String translated = translate.translate("Hello, world!", "en", "ru");
